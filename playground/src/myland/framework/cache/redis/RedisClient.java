...
public class RedisClient {
	...
	public Long hincrBy(String key, String field, Long value) {
		return redisTemplate.<String, Object> opsForHash().increment(key,
				field, value);
	}
	...
	public Boolean hsetnx(String key, String field, Object value) {
		return redisTemplate.<String, Object> opsForHash().putIfAbsent(key,
				field, value);
	}
	...
	public void sdiffstore(String key, Collection<String> keys,
			String destinations) {
	...
	public void sinterstore(String key, Collection<String> keys,
			String destination) {
	...
	public void sunionstore(String key, Collection<String> keys,
			String destination) {
	...
	public void zinterstore(String key, Collection<String> keys,
			String destination) {
	...
	public Object zrevrange(String key, Long start, Long end, Boolean withScore) {
		if (withScore != null && withScore) {
			return redisTemplate.opsForZSet().reverseRangeWithScores(key,
					start, end);
		}
	...
	public void zunionstore(String key, Collection<String> keys,
			String destination) {
